...
const BASE = "https://emergenza.studio";

export default function sitemap(): MetadataRoute.Sitemap {
  const pages = [
    { url: "/", priority: 1.0, changeFrequency: "weekly" as const },
    { url: "/servizi", priority: 0.9, changeFrequency: "monthly" as const },
    { url: "/materie", priority: 0.9, changeFrequency: "monthly" as const },
    ...
    { url: "/chi-siamo", priority: 0.7, changeFrequency: "monthly" as const },
    { url: "/contatti", priority: 0.8, changeFrequency: "monthly" as const },
