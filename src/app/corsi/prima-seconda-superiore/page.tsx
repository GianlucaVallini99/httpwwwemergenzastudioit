...
const WHATSAPP_CORSO = "https://wa.me/393534017905?text=Ciao!%20Vorrei%20informazioni%20sul%20Corso%20di%20Matematica%20per%20il%20passaggio%20dalla%20prima%20alla%20seconda%20superiore";
const PHONE_CORSO = "353 401 7905";
const PHONE_CORSO_INTL = "+393534017905";

const breadcrumbs = [
  { label: "Corsi", href: "/corsi" },
  { label: "Corso Prima-Seconda Superiore", href: "/corsi/prima-seconda-superiore" },
];

const targetList = [
  "Studenti che hanno concluso la prima superiore e vogliono consolidare le basi prima della seconda",
  "Ragazzi che hanno avuto difficoltà durante il primo anno in matematica",
  "Famiglie che vogliono evitare il debito formativo e iniziare la seconda con sicurezza",
];
...
const settimane = [
  {
    ...
    argomenti: [
      ...
      "Scomposizione con prodotti notevoli e metodo di Ruffini",
      "M.C.D. e m.c.m. di polinomi",
    ],
    perche: "La scomposizione è il passaggio chiave per lavorare con le frazioni algebriche. Chi non la padroneggia si blocca su tutto il programma di seconda.",
  },
  {
    num: 2,
  ...
  },
  {
    ...
    argomenti: [
      ...
      "Interpretazione grafica: rette nel piano cartesiano",
      "Problemi con sistemi: impostazione e risoluzione",
    ],
    perche: "I sistemi tornano nella geometria analitica e nella fisica. Padroneggiarli adesso evita problemi a cascata nei mesi successivi.",
  },
  {
    num: 5,
...
const faqs = [
  {
    q: "Il corso è adatto anche a chi frequenta un istituto tecnico?",
    a: "Sì. Il programma copre gli argomenti fondamentali di matematica comuni a licei scientifici e istituti tecnici. Per altri indirizzi, scrivici: valutiamo insieme se il corso è adatto.",
  },
  {
  ...
  {
    q: "Il corso è utile anche per chi ha già il debito in matematica?",
    a: "Il corso è pensato per consolidare e potenziare, non per recuperare un debito formativo in senso stretto. Se lo studente ha un debito, possiamo affiancare il corso con ripetizioni individuali mirate — scrivici per un piano personalizzato.",
  },
];

export default function PrimaSecondaSuperioriPage() {
  return (
    <>
      {/* ── JSON-LD ── */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(breadcrumbJsonLd([
            ...
            { name: "Corso Prima-Seconda Superiore", href: "/corsi/prima-seconda-superiore" },
          ])),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(courseJsonLd([{
            name: "Corso Passaggio Prima-Seconda Superiore di Matematica",
            description: "Corso di matematica per studenti che hanno concluso la prima superiore. 5 settimane, 20 ore totali, max 5 studenti per gruppo.",
        ...
        <div className="container-custom">
          <div className="max-w-4xl">
            ...
            <h1
              ...
              style={{ fontFamily: "var(--font-display)" }}
            >
              Corso di Matematica: dalla Prima alla Seconda Superiore
            </h1>
            <p className="text-xl md:text-2xl text-foreground/70 mb-8 font-medium leading-snug max-w-3xl">
              5 settimane per consolidare la prima superiore e arrivare preparati alla seconda. Piccoli gruppi, docenti esperti, programma mirato.
            </p>
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4 text-center">
              La seconda superiore alza il livello: frazioni algebriche, disequazioni, sistemi, radicali. Chi ha trascinato incertezze dalla prima si ritrova sommerso già a ottobre. Questo corso serve a chi vuole partire dalla seconda con le basi solide.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-8 text-center font-medium">
              Non è un recupero: è una preparazione mirata per non averne bisogno.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto mb-8">
            ...
            <div className="rounded-2xl bg-white border border-border p-8 flex flex-col">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed mb-6 flex-1">
                Per chi vuole concentrarsi solo sui blocchi dove sente più difficoltà o vuole iniziare gradualmente.
              </p>
              <a
                href={WHATSAPP_CORSO}
                target="_blank"
